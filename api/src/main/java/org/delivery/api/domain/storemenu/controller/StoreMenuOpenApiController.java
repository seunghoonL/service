...
public class StoreMenuOpenApiController {
    ...
    public Api<StoreMenuResponse> register(@Valid @RequestBody Api<StoreMenuRegisterRequest> registerRequest){
        var response = storeMenuBusiness.register(registerRequest.getBody());
